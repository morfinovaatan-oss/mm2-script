...
-- Простая проверка роли по оружию (без использования RemoteEvent)
...
-- Для Silent Aim: найти мёрдера (игрок с ножом)
...
-- Инициализация визуальных объектов
            ...
            if Config.SilentAim then
                ...
                if murderer then
                    ...
                    if char and char.PrimaryPart then
                        ...
                        local aimPos = root.Position + velocity * Vector3.new(Config.Prediction / 200, 0, Config.Prediction / 200)
                        args[2] = aimPos
                    end
                end
            end
...
task.spawn(function()
    while true do
        ...
        if isCharacterValid(character) then
            ...
            -- AutoGun
            if Config.AutoGun and getLocalRole() == "Innocent" then
