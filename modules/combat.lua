-- [[ MM2 COMBAT MODULE – адаптированный под UILibrary v1.6 ]] --
local Combat = {}
...
function Combat.Init(GlobalConfig, parentTab, Lang)
    ...
    local function addKeybindRow(keyName, configKeyString)
        local label = KeysGroup:AddLabel(Combat.Config[configKeyString] and (keyName .. " : " .. tostring(Combat.Config[configKeyString]):gsub("Enum.KeyCode.", "")) or (keyName .. " : None"))
        KeysGroup:AddButton({
